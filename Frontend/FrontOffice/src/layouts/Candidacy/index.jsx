...
function Candidacy() {
  const { selectedOffer } = useParams(); // Récupérer l'ID de l'offre à partir de l'URL
...
console.log(userId);
  ...
  useEffect(() => {
    if (selectedOffer) {
      // Si l'ID de l'offre est présent dans l'URL, sélectionnez automatiquement cette offre
      setOffreSelectionnee(selectedOffer);
